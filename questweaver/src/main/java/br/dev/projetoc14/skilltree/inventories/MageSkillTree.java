...
public class MageSkillTree {
    ...
    public static void mageSkillTree(Player player) {
        ...
        ItemStack especialItem = new ItemStack(Material.BLAZE_POWDER);
        ...
        assMeta.setLore(Arrays.asList(
                ...
                ChatColor.GRAY + "♦ Aumenta a área de explosão",
                ChatColor.GRAY + "♦ Reduz o tempo de cooldown",
                ChatColor.GRAY + "♦ Reduz custo de mana"
        ));
